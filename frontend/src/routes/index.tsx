        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                children: [{ path: 'alerts', lazy: lazyComponent(() => import('@/pages/alerts/AlertsPage')) }],
              },
              {
                element: <PermissionGate permission={PERMISSIONS.TARGET_VIEW} />,
                children: [{ path: 'targets', lazy: lazyComponent(() => import('@/pages/alerts/TargetsPage')) }],
              },
              {
              ...
              },
              {
                ...
                children: [
                  { path: 'students', lazy: lazyComponent(() => import('@/pages/students/StudentsPage')) },
                  { path: 'students/:id', lazy: lazyComponent(() => import('@/pages/students/StudentProfilePage')) },
                ],
              },
              {
              ...
              {
                element: <PermissionGate permission={PERMISSIONS.HOMEWORK_VIEW} />,
                children: [{ path: 'homework', lazy: lazyComponent(() => import('@/pages/homework/HomeworkPage')) }],
              },
              {
                element: <PermissionGate permission={PERMISSIONS.EXAM_VIEW} />,
                children: [{ path: 'exams', lazy: lazyComponent(() => import('@/pages/homework/ExamsPage')) }],
              },
              {
              ...
              {
                element: <PermissionGate permission={PERMISSIONS.COMMISSION_VIEW_OWN} />,
                children: [{ path: 'my-earnings', lazy: lazyComponent(() => import('@/pages/teachers/MyEarningsPage')) }],
              },
              {
              ...
              {
                element: <PermissionGate permission={PERMISSIONS.EMPLOYEE_VIEW} />,
                children: [{ path: 'employees', lazy: lazyComponent(() => import('@/pages/employees/EmployeesPage')) }],
              },
              {
